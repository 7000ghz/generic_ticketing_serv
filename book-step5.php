...
<div class="w3-content" style="max-width:1532px;">
          ...
          <div class="book5">
              <div class="bookpending">
                    <p>Please wait for our email and text message of your payments reference codes.</p>
              </div>
          ...
          <br><br><br><br>
          <div class="steps">
            <!-- <a href="book-step4.php">Click here to go back to previous page</a> -->
          </div><!-- step5 -->
            <br>
